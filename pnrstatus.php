...
$row = mysqli_fetch_assoc($result);
	if($row==NULL)	echo "<script type='text/javascript'>alert('Booking ID not found');</script>";
...
<center>
	...
	<div id="pnrtext"><input type="text" name="pnr" size="30" maxlength="10" placeholder="Enter Booking IdDhere"></div>
	<br/><br/>
